...
def scan_yahoo_items(data_engine, items: list[dict], workers: int = 4):
    ...
    def run(item):
        ...
        return {
            ...
            "Kalite": signal.get("quality", "D"),
            "Puan": signal["score"],
            "Fiyat": signal.get("price", 0),
            "Stop": signal.get("stop", 0),
            "Hedef 1": signal.get("target1", 0),
            "Hedef 2": signal.get("target2", 0),
            "R/K 1": signal.get("risk_reward1", 0),
            "R/K 2": signal.get("risk_reward2", 0),
            "RSI": signal.get("rsi"),
            "ADX": signal.get("adx"),
